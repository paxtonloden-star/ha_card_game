...
BUILTIN_DECKS: dict[str, DeckDefinition] = {
    ...
    "judge_party": DeckDefinition(
        slug="judge_party",
        name="Judge Party",
        description="Judge-based fill-in-the-blank party deck with black prompts and white answer cards.",
        prompts=[
            "At family game night, the wildcard was ___.",
            "The judge picked ___ as the winning answer.",
            "The unexpected reason everyone laughed was ___.",
            "Our house rule now bans ___.",
            "The remote player won the round with ___.",
        ],
        white_cards=[
            "an aggressively dramatic pause",
            "a suspiciously specific fun fact",
            "retro cereal energy",
            "button-mashing confidence",
            "one wildly overcommitted dad joke",
            "a speedrun mentality",
            "bonus glitter",
            "a couch co-op betrayal",
            "that one unbeatable comeback",
        ],
